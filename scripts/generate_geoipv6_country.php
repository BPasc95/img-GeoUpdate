...
$filename = GENERATED_FILES_DIR . "geoip_mm_country_ipv6.txt";
...
$sql_command = ("SELECT 
blocks_country_ipv6.network_cidr,
blocks_country_ipv6.geoname_id, 
blocks_country_ipv6.registered_country_geoname_id, 
blocks_country_ipv6.is_anonymous_proxy, 
location_country.country_iso_code
FROM 
blocks_country_ipv6, 
location_country 
WHERE 
blocks_country_ipv6.geoname_id = location_country.geoname_id AND
blocks_country_ipv6.network_cidr != 'network' 
...
$line = "# GEOIP2 COUNTRY CREATED $today \r\n\r\n";
...
location_country 
WHERE 
blocks_country_ipv6.registered_country_geoname_id = location_country.geoname_id AND
blocks_country_ipv6.network_cidr <> 'network' AND
blocks_country_ipv6.is_anonymous_proxy = 1 AND
blocks_country_ipv6.network_cidr != 'network' 
...
blocks_country_ipv6.geoname_id, 
blocks_country_ipv6.registered_country_geoname_id, 
blocks_country_ipv6.is_satellite_provider,
location_country.country_iso_code
FROM 
blocks_country_ipv6, 
location_country 
...
blocks_country_ipv6.registered_country_geoname_id = location_country.geoname_id AND
blocks_country_ipv6.network_cidr <> 'network' AND
blocks_country_ipv6.is_satellite_provider = 1 and
blocks_country_ipv6.network_cidr != 'network'
");
